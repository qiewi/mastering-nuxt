<template>
  <section class="space-y-12 flex flex-col items-center py-16 px-8 bg-white">
    <h1 class="text-7xl font-black text-blue-500 m-0 pb-16">
      {{ course.title }}
    </h1>
    <img
      :src="screenshots[0]"
  ...
  <Section title="Course Preview" variant="white">
    <div class="container mx-auto px-4 py-16">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div
          class="overflow-hidden rounded-lg shadow-lg transform hover:scale-105 hover:-rotate-2 transition-transform duration-300"
        >
          <img
            :src="screenshots[0]"
            alt="Screenshot 1"
  ...
  <Section title="Course Outline" variant="blue">
...
const screenshots = [CourseScreen];
